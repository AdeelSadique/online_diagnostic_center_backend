                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div
                                                                    ...
                                                                    <p style="margin: 0; word-break: break-word;">
                                                                        <span>Hey, we received a request to reset your
                                                                            password.</span>
                                                                    </p>
                                                                </div>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div
                                                                    style="color:#40507a;font-family:Helvetica Neue, Helvetica, Arial, sans-serif;font-size:16px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
                                                                    <p style="margin: 0; word-break: break-word;">
                                                                        <span>Let’s get you a new one!</span>
                                                                    </p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    ...
                                                    <table class="button_block block-4" width="100%" border="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <div class="alignment" align="left"><a
                                                                        href="http://localhost:5173/passwordReset?token={{ $token }}"
                                                                        target="_blank"
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div
                                                                    ...
                                                                    <p style="margin: 0; word-break: break-word;">
                                                                        <span>Having trouble? <a href=""
                                                                                target="_blank"
                                                                                title=admin@fasttest.com"
                                                                                style="text-decoration: none; color: #40507a;"
                                                                                rel="noopener"><strong>admin@fasttest.com</strong></a></span>
                                                                    </p>
                                                                </div>
                                                            </td>
                                                        </tr>
